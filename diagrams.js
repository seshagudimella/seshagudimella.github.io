/* ============================================================
   ...
   diagrams.js — All SVG diagram definitions and DOM injection
   Each diagram is stored as a template string and injected into
   its matching placeholder element on DOMContentLoaded.
   ============================================================ */

const DIAGRAMS = {

  /* Hero — cloud topology hub-and-spoke */
  heroTopology: `
  ...
  /* Impact card 1 — monthly AWS spend bar chart */
  costChart: `
  ...
  /* Impact card 2 — CI pipeline before/after */
  ciPipeline: `
  ...
  /* Impact card 3 — tool consolidation flow */
  consolidation: `
  ...
  /* Impact card 4 — incident & postmortem framework metrics */
  incidentFramework: `
  ...
  /* Stack section — platform ownership map */
  platformMap: `
...
/* Inject each diagram into its matching placeholder element */
document.addEventListener('DOMContentLoaded', () => {
  Object.entries(DIAGRAMS).forEach(([key, svg]) => {
